...
//         <ul className={`hidden top-[100px] md:flex menu menu-horizontal  ${isDark ? '' : 'text-white  specialGradient rounded-lg'}`}>
...
//           </button>
//           {mobileMenuShow && (
//             <ul className={`menu absolute menu-vertical  z-10 right-0 top-12 bg-base-100 text-white ${user?'specialGradient':'hidden'}  w-52 shadow-lg rounded ${isDark ? 'bg-black text-white' : ''}`}>
...
const Navbar = () => {
  ...
  return (
    <div ref={navbarRef} className={`navbar bg-base-100 shadow-sm container rounded-lg px-4 mx-auto${isDark ? ' bg-black text-white' : ''}`}>
      <div className='flex-1 flex items-center'>
        <Link to='/' className='flex gap-2 items-center'>
          <img className='w-auto h-7' src={harvardLogo} alt='Harvard Logo' />
          <span className='font-bold lg:text-2xl'>ABROAD <i className='bg-gradient-to-r from-red-500 to-red-700 text-transparent bg-clip-text'>UNIVERSITY</i></span>
      ...
      <div className='flex-none flex items-center gap-4'>
        ...
        <div className='relative'>
          ...
          {mobileMenuShow && (
            <ul ref={dropdownRef} className={`menu absolute menu-vertical z-10 right-0 top-12 bg-base-100 text-white ${user ? 'specialGradient' : 'hidden'} w-52 shadow-lg rounded ${isDark ? 'bg-black text-white' : ''}`}>
              <li className='rounded lg:hidden'>
                <Link to='/'>Home</Link>
              </li>
              <li className='rounded lg:hidden'>

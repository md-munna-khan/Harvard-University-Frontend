...
//                     <tr>
//                       <th className='py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500'>Image URL</th>
...
//                       <tr key={service._id}>
//                         <td className='px-4 py-4 text-sm text-gray-500 whitespace-nowrap'> <img className="w-20 h-10 lg:h-20 rounded-full" src={service.image} alt="" /></td>
//                         <td className='px-4 py-4 text-sm text-gray-500 whitespace-nowrap'>{service.title}</td>
//                         <td className='px-4 py-4 text-sm text-gray-500 whitespace-nowrap'>${service.service_price}</td>
//                         <td className='px-4 py-4 text-sm text-gray-500 whitespace-nowrap'>{service.area}</td>
//                         {/* <td className='px-4 py-4 text-sm text-gray-500 whitespace-nowrap'>{service.description.substring(0, 70)}...</td> */}
                                        ...
                                        {services.map((service) => (
                                            <tr key={service._id}>
                                                <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                                                    <img className="w-20 h-10 lg:h-20 rounded-full" src={service.serviceImage} alt={service.serviceName} />
                                                </td>
                                                <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{service.serviceName}</td>
                                                <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">${service.price}</td>
                                                <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{service.area}</td>
                                                <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{service.description?.substring(0, 70)}...</td>
                                                <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div className="flex items-center gap-x-6">

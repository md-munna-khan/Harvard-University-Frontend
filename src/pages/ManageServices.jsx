...
//                         <p
//                           className={`px-3 py-1  
//                             ${service.category ==='Web Development' ? 'text-blue-500 bg-blue-100/60':''}
//                             ${service.category ==="Digital Marketing" ? 'text-green-500 bg-blue-100/60':''}
//                             ${service.category ==="Graphics Design" ? 'text-red-500 bg-blue-100/60':''}

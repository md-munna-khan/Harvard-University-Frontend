...
//     return (
//       <div className={`flex justify-center items-center min-h-[calc(100vh-306px)] my-12${isDark?'bg-black text-white':''}`}>
      ...
      <section className='p-2 md:p-6 mx-auto bg-white dark:bg-gray-800 rounded-md shadow-md'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
            ...
            <div>
              <label className='text-gray-700 dark:text-gray-300' htmlFor='service_price'>
                Price
              </label>
              <input
                id='service_price'
            ...
            <div>
              <label className='text-gray-700 dark:text-gray-300' htmlFor='service_area'>
                Service Area
              </label>
              <input
                id='service_area'
